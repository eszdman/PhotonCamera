#ifndef HALIDE____mnt___B___AndroidStudioProjects___halide___align___build___android___android___alignburst_f16_h
#define HALIDE____mnt___B___AndroidStudioProjects___halide___align___build___android___android___alignburst_f16_h
#include <stdint.h>
...
int alignburst_f16(struct halide_buffer_t *_base_l0_buffer, struct halide_buffer_t *_base_l1_buffer, struct halide_buffer_t *_base_l2_buffer, struct halide_buffer_t *_base_l3_buffer, struct halide_buffer_t *_base_l4_buffer, struct halide_buffer_t *_alt_raw_buffer, float _white_level, struct halide_buffer_t *_alignments__1_buffer);

HALIDE_FUNCTION_ATTRS
int alignburst_f16_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *alignburst_f16_metadata();
