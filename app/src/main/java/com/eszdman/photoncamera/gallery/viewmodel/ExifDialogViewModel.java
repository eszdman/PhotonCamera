...
//        Log.d("attr_35mmfocal", "fetched attr_35mmfocal = " + attr_35mmfocal);
        ...
        String exposure = (Utilities.formatExposureTime(Double.parseDouble(attr_exp == null ? "-1" : attr_exp)));
        String resolution_mp = (String.format(Locale.US, "%.1f",
                Double.parseDouble((attr_width == null ? "-1" : attr_width))
                        * Double.parseDouble((attr_length == null ? "-1" : attr_length)) / 1E6) + " MP");
        ...
        exifDialogModel.setFocal(Rational.parseRational(attr_focal).doubleValue() + "mm");
    ...
    private String getDateText(String savedDate) {
        ...
        return displayedDateFormat.format(photoDate);
    }
}
